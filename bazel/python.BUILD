...
cc_library(
    ...
    hdrs = select(
        {
            "@bazel_tools//tools/python:PY2": glob(["lib/python2.7/dist-packages/numpy/core/include/**/*.h"]),
    ...
    includes = select(
        {
            "@bazel_tools//tools/python:PY2": ["lib/python2.7/dist-packages/numpy/core/include"],
